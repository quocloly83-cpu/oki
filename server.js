...
<body>
  <div class="splash" id="splash">
    <div class="splashLogo">
      <img src="/logo.png" alt="AimTrickHead Logo">
    </div>
      ...
      <div class="content">
        ...
        <div id="panelView" class="hidden">
          ...
          <div class="liveFx" id="liveFxBox">
            <span class="fxLine">⚡ Chờ kích hoạt module...</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    function saveSession(token) {
      localStorage.setItem("ath_session", token);
    }

    function getSession() {
      return localStorage.getItem("ath_session");
    }
